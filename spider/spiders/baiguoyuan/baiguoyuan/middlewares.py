...
class BaiguoyuanSpiderMiddleware(object):
...
class BaiguoyuanDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
import requests
import time
from proxy.adslproxy.pull import PullProxy

# 代理服务器
proxy_url = "http://192.168.50.144:8000"

# 代理隧道验证信息
proxyUser = "sdg_develop"
proxyPass = "sdg666888"
...
class UAMiddleware(object):
    ...
    def process_request(self, request, spider):
        ua = random.choice(UAMiddleware.USER_AGENT_LIST)
